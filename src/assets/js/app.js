...
const settings = {
  ...
  resourcesRefreshSelect: document.getElementById('resourcesRefreshSelect'),
  networkRefreshSelect: document.getElementById('networkRefreshSelect'),
  batteryRefreshSelect: document.getElementById('batteryRefreshSelect'),
